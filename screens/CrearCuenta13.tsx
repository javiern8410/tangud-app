...
const CrearCuenta13 = () => {
  ...
  return (
    <>
      <View style={styles.crearCuenta13}>
        <Image
        ...
        <View style={styles.tabs}>
          <Pressable
            style={[styles.tabTerminos, styles.tabLayout]}
            onPress={() => navigation.navigate("CrearCuenta12")}
          >
            <View style={styles.tabBackground} />
            <View style={[styles.rectngulo1480, styles.rectnguloPosition1]} />
            <Text style={[styles.trminosYCondiciones, styles.aceptoPosition]}>
              Términos y condiciones
            </Text>
          </Pressable>
          <View style={[styles.tabPolitica, styles.tabPosition]}>
            <View style={styles.tabBackground} />
