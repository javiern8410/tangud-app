...
const RecuperarCuenta2 = () => {
  ...
  return (
    <>
      <Pressable
        style={styles.recuperarCuenta2}
        onPress={() => navigation.navigate("RecuperarCuenta3")}
      >
        <Image
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/tangud-color23.png")}
        />
        ...
        <View style={styles.input}>
          ...
          <View style={[styles.lnea3, styles.textPosition]} />
          <Image
