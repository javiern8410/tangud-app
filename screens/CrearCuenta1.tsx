...
const CrearCuenta1 = () => {
  ...
  return (
    <>
      <View style={styles.crearCuenta1}>
        <Image
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/tangud-color26.png")}
        />
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("CrearCuenta2")}
        >
          <View style={[styles.rectngulo2, styles.rectnguloShadowBox]} />
          <Text style={[styles.emailDeTu, styles.emailDeTuPosition]}>
            Email de tu cuenta
          </Text>
          <Image
        ...
        <View style={styles.input1}>
          ...
          <Text style={[styles.unNombrePara, styles.emailDeTuPosition]}>
            Un nombre para tu perfil
          </Text>
          <Image
            style={[styles.enmascararGrupo201, styles.enmascararPosition]}
            contentFit="cover"
