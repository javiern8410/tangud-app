...
const RecuperarCuenta4 = () => {
  ...
  return (
    <>
      <View style={styles.recuperarCuenta4}>
        <Image
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/tangud-color21.png")}
        />
        ...
        <View style={styles.input}>
          ...
          <Text style={styles.miemailemaildomcom}>miemail@emaildom.com</Text>
          <Image
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("RecuperarCuenta5")}
        >
...
export default RecuperarCuenta4;
