...
const CrearCuenta5 = () => {
  ...
  return (
    <>
      <Pressable
        style={styles.crearCuenta5}
        onPress={() => navigation.navigate("CrearCuenta6")}
      >
        <Image
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/tangud-color6.png")}
        />
